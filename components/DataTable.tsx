...
import { Application, BBStatus } from '../types';
...
import { BB_STATUS_FILTER_OPTIONS } from '../constants'; // Options for the dropdown
              ...
              {TABLE_HEADERS.map(header => (
                <th
                  ...
                  className={`px-2 py-3 text-[12px] font-medium text-gray-500 uppercase tracking-wider text-center ${ // Applied text-center as default
                    ...
                    header === "PTP" ? "min-w-[80px]" : "" // text-center is now default
                  } ${
