...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:justify-between space-y-3 md:space-y-0 md:space-x-3 p-1">
      <input
        type="text"
        placeholder="Search by Dealer, Primary Name, Dlr Id, Shaw Accnt#"
        className="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-gray-700"
        value={searchTerm}
